...
export class CommonEventManager {
  ...
  private subscriber: commonEventManager.CommonEventSubscriber; // Saves the created subscriber object for subsequent subscription and unsubscription.
  ...
  // Creating a subscriber callback
